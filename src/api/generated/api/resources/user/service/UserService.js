...
class UserService {
    ...
    toRouter() {
        this.router.post("/register", (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            const request = yield serializers.RegisterUserRequest.parse(req.body);
            if (request.ok) {
        ...
        this.router.post("/login", (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            const request = yield serializers.LoginUserRequest.parse(req.body);
            if (request.ok) {
                req.body = request.value;
                try {
                    yield this.methods.login(req, {
                        send: (responseBody) => __awaiter(this, void 0, void 0, function* () {
                    ...
                    if (error instanceof errors.RespondIoApiError) {
                        switch (error.errorName) {
                            ...
                            case "ServerError":
                                break;
                            default:
                                console.warn(`Endpoint 'login' unexpectedly threw ${error.constructor.name}.` +
                                    ` If this was intentional, please add ${error.constructor.name} to` +
                                    " the endpoint's errors list in your Fern Definition.");
                        }
                        yield error.send(res);
