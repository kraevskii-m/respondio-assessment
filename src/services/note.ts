...
export default new NoteService({
    async all(req: e.Request<never, NoteObject[], never, never>, res: {
    ...
    async delete(req: e.Request<{ noteId: number }, MessageOk, never, never>, res: {
    ...
    async single(req: e.Request<{ noteId: number }, NoteObject, never, never>, res: {
        send: (responseBody: NoteObject) => Promise<void>;
        cookie: (cookie: string, value: string, options?: e.CookieOptions) => void;
        locals: any
    }): Promise<void> {
    ...
    async update(req: e.Request<{ noteId: number }, MessageOk, UpdateNoteRequest, never>, res: {
        send: (responseBody: MessageOk) => Promise<void>;
        cookie: (cookie: string, value: string, options?: e.CookieOptions) => void;
        locals: any
    }): Promise<void> {
    ...
    async create(req: e.Request<never, NoteObject, CreateNoteRequest, never>, res: {
        send: (responseBody: NoteObject) => Promise<void>;
        cookie: (cookie: string, value: string, options?: e.CookieOptions) => void;
        locals: any
    }): Promise<void> {
